...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _saveProfileData(String key, dynamic value) async {
    ...
    const apiUrl = 'http://10.0.2.2:5000/api/update_profile';
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        key:
            value, // Send the dynamic key-value pair (password, firstName, etc.)
      }),
    );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ProfileCard(
              //   title: 'Роль',
              //   text: localizedRole ?? 'Loading...',
              //   icon: const Icon(Icons.people_rounded,
              //       size: 24, color: Colors.white),
              //   onSave: (value) => _saveProfileData(
              //       'role', value), // You can save role changes similarly
              // ),
              // const SizedBox(height: 15),
              // ProfileCard(
              //   title: 'Монеты',
              ...
              //       size: 24, color: Colors.white),
              //   onSave: (value) => _saveProfileData('coins', value),
              // ),
              const SizedBox(height: 15),
              ElevatedButton(
